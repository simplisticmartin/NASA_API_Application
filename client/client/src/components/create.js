...
export default class Create extends Component {
  ...
  constructor(props) {
    ...
    this.onChangePersonRating = this.onChangePersonRating.bind(this);
  ...
  onChangePersonRating(e) {
    this.setState({
      person_rating: e.target.value,
    });
  }
  ...
  onSubmit(e) {
    ...
    const newperson = {
      ...
      person_rating: this.state.person_rating,
    };
    ...
    return (
      <div style={{ marginTop: 20 }}>
        ...
        <form onSubmit={this.onSubmit}>
          ...
          <div className="form-group">
            <label>Person's Rating ;): </label>
            <input
              type="text"
              className="form-control"
              value={this.state.person_rating}
              onChange={this.onChangePersonRating}
            />
          </div>
          <div className="form-group">
            <input
